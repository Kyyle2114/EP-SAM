...
def get_args_parser():
    ...
    parser.add_argument('--dataset_type', type=float, default=0.75, help='pseudo mask dataset option')
...
def main(rank, opts) -> str:
    ...
    train_set = dataset.make_dataset(
        image_dir=f'/home/team1/ddrive/team1/sam_dataset/camelyon17_classifier_train9000by9000/val/image',
        mask_dir=f'/home/team1/ddrive/team1/SAM_WSSS_CAM/SAM_WSSS_CAM_0705/code/pseudo_mask_generation/outputs_vit_b_cam17/val_pseudo_masks',
        transform=transform
    )
    ...
    val_set = dataset.make_dataset(
        image_dir=f'/home/team1/ddrive/team1/sam_dataset/camelyon16_5tests/image',
        mask_dir=f'/home/team1/ddrive/team1/sam_dataset/camelyon16_5tests/mask'
    )
    ...
    es = trainer_cuda0.EarlyStopping(patience=5, delta=0, mode='max', verbose=True)
    ...
    for epoch in range(EPOCHS):
        ...
        train_bce_loss, train_iou_loss, train_dice, train_iou = trainer_cuda0.model_train(
            model=model,
        ...
        if opts.rank == 0:
            val_bce_loss, val_iou_loss, val_dice, val_iou = trainer_cuda0.model_evaluate(
                model=model,
            ...
            ### Save best model ###
            if val_iou > max_iou:
                print(f'[INFO] val_iou has been improved from {max_iou:.5f} to {val_iou:.5f}. Save model.')
                max_iou = val_iou
