...
class BasicClassifier(nn.Module):
    def __init__(self, model, in_features, freezing=False, num_classes=1, dataset_type='cam16'):
        """
    ...
    def make_cam(
        ...
        elif self.dataset_type == 'internel':
