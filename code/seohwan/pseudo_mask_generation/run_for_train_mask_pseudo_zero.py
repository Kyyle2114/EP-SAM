...
from adl import adl_fft_internel_mask
from generate_mask_for_train_fft_mask import make_mask
...
def main(opts):
    ...
    # Classifier
    cls = adl_fft_internel_mask.resnet50_adl(
    ...
    df = make_mask(
        ...
        output_path='outputs_vit_b_Internel_cam',
    ...
    compare_mask(
        mask_dir=opts.train_mask_dir,
        pmask_dir=f'outputs_vit_b_Internel_cam/{opts.pmask_dir}',
    )
