...
# python3 run_for_train_point_pseudo_softmax.py \
#     --batch_size 1 \
#     --patch_size 512 \
#     --seed 21 \
#     --model_type vit_b \
#     --checkpoint_sam sam_vit_b.pth \
#     --checkpoint_decoder /home/team1/ddrive/team1/SAM_WSSS_CAM/SAM_WSSS_CAM_0705/code/segmentor/SAM/checkpoints/sam_internel_ADL_0.35_filter_iter_1_30per_point.pth \
...
#     --pmask_dir train_pseudo_masks_0.4_filter_iter3_test
...
# /home/team1/ddrive/team1/SAM_WSSS_CAM/SAM_WSSS_CAM_0705/code/segmentor/SAM/checkpoints/sam_internel_cam_full_filter_iter_1_dice_iou_lr_5e-6_point_prompt_proba_real.pth
# /home/team1/ddrive/team1/SAM_WSSS_CAM/SAM_WSSS_CAM_0717/code/classifier/checkpoints/internel_resnet_real_lr_best.pth
# /home/team1/ddrive/team1/SAM_WSSS_CAM/SAM_WSSS_CAM_0717/code/classifier/checkpoints/internel_adl_real_lr_best.pth