...
def make_pseudo_mask(
    ...
    save_mask_dir = f'{output_path}/train_pseudo_masks_cam17_ADL_fft'
    ...
    with torch.no_grad():
        ...
        for X, y, _, file_name in tqdm(data_loader):
            ...
            for output in batched_output:
                ...
                cam_mask.save(f'{save_dir}/train_cam_masks_cam17_ADL_fft/{file}')
                
        df = pd.DataFrame(output_dict)
        df.to_csv(f'{save_dir}/train_pseudo_masks_cam17_ADL_fft.csv')
