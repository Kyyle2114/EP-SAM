...
from generate_mask_for_train_fft_whole_box import make_box_mask
...
def main(opts):
    ...
    df = make_box_mask(
        ...
        output_path='outputs_vit_b_internel_whole_box_comparison',
    ...
    compare_mask(
        mask_dir=opts.test_mask_dir,
        pmask_dir=f'outputs_vit_b_internel_whole_box_comparison/{opts.pmask_dir}'
    )
