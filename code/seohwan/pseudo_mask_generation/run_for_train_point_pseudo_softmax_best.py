...
from generate_mask_for_train_fft_point_softmax_best import make_point_mask
...
def main(opts):
    ...
    df = make_point_mask(
        ...
        output_path='outputs_vit_b_internel_best50',
    ...
    compare_mask(
        mask_dir=opts.test_mask_dir,
        pmask_dir=f'outputs_vit_b_internel_best50/{opts.pmask_dir}'
    )
