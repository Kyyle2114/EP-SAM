...
from model import basic_classifier_thres_2_data_custom
...
def get_args_parser():
    ...
    parser.add_argument('--dataset_type', type=str, default='cam17', help='dataset type')
    parser.add_argument('--test_or_train', type=str, default='train', help='train or test')
...
def main(opts):
    ...
    # elif opts.model_type == 'gradcamplpl':
        ...
        cls = basic_classifier_thres_2_data_custom.BasicClassifier(
            model=resnet, 
    ...
    print("Model type : " + opts.model_type, "morphology : " + str(opts.morphology) + " dataset : " + str(opts.dataset_type)  + ' ' +  str(opts.test_or_train))
