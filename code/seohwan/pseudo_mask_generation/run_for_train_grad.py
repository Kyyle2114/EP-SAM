...
from adl import adl
from generate_mask_for_train_grad import make_pseudo_mask
...
def main(opts):
    ...
    df = make_pseudo_mask(
        ...
        output_path='outputs_vit_b_TIGER_real',
        device=device
    )
    ...
    compare_mask(
        mask_dir=opts.train_mask_dir,
        pmask_dir='outputs_vit_b_TIGER_real/train_pseudo_masks_tiger_resnet_val'
    )
