...
from generate_mask_for_train_fft_point import make_point_mask
...
def main(opts):
    ...
    df = make_point_mask(
        ...
        output_path='outputs_vit_b_internel_random_point_comparison',
    ...
    compare_mask(
        mask_dir=opts.test_mask_dir,
        pmask_dir=f'outputs_vit_b_internel_random_point_comparison/{opts.pmask_dir}'
    )
