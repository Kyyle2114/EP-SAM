        ...
        for X, y, _, file_name in tqdm(data_loader):
            ...
            for image, gt_mask, file in zip(X_torch, y_torch, file_name):
                ...
                if logit.item() >= 0:
                    ...
                    point_coords = make_point_prompt_half(mask=gt_mask.squeeze().cpu().numpy(), n_point=50)
            ...
            for output in batched_output:
                ...
                cam_mask.save(f'{save_dir}/train_point_prompt_iter1_gt25_non25_points_cam_masks/{file}')
