...
from adl import adl_fft
from generate_mask_for_train_fft import make_pseudo_mask
...
def main(opts):
    ...
    df = make_pseudo_mask(
        ...
        output_path='outputs_vit_b_cam17',
        device=device
    )
    ...
    compare_mask(
        mask_dir=opts.train_mask_dir,
        pmask_dir='outputs_vit_b_cam17/train_pseudo_masks_cam17_ADL_fft'
    )
